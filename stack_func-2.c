 ...
 * @stack : shows pointer pointing to top node of the stack.
 ...
 * @stack: gives pointer pointing to top node of the stack.
 * @line_number: gives interger representing the line number of of the opcode.
 */
 ...
 * @stack: gives  pointer to a pointer pointing to top node of the stack.
 * @line_number: Interger representing the line number of of the opcode.
 */
